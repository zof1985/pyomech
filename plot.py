...
def set_layout(ax, x_label="", y_label_left="", y_label_right="", z_label="",
    ...
    try:
        ...
        ax.spines["left"].set_smart_bounds(y_smart_ticks)
        ax.spines["bottom"].set_linewidth(axis_width)
        ax.spines["bottom"].set_smart_bounds(x_smart_ticks)
    except Exception:
        for axis in ax.axes:
            axis.spines["right"].set_visible(False)
            axis.spines["top"].set_visible(False)
            axis.spines["left"].set_linewidth(axis_width)
            axis.spines["left"].set_smart_bounds(y_smart_ticks)
            axis.spines["bottom"].set_linewidth(axis_width)
            axis.spines["bottom"].set_smart_bounds(x_smart_ticks)
